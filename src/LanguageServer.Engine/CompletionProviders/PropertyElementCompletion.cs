...
namespace MSBuildProjectTools.LanguageServer.CompletionProviders
{
        ...
        : CompletionProvider
    {
        ...
        /// </summary>
        public HashSet<string> WellKnownPropertyNames { get; } = new HashSet<string>
        {
            "OutputType",
            "TargetFramework",
            "TargetFrameworks",
        ...
        public IEnumerable<CompletionItem> GetCompletionItems(ProjectDocument projectDocument, Range replaceRange)
        {
            ...
            if (!projectDocument.HasMSBuildProject)
                yield break; // Without a valid MSBuild project, we can't inspect existing MSBuild properties.
        ...
        /// </param>
        /// <param name="priority">
        ///     The item sort priority (defaults to <see cref="Priority"/>).
        /// </param>
